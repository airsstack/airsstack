...
/// Placeholder for sub-project data structure
///
/// This will be fully implemented in the project.rs module
/// but is referenced here for the workspace data model.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
pub struct SubProject {
    /// Placeholder field - will be expanded in project.rs
    pub name: String,
}
