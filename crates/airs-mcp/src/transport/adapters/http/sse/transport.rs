...
impl HttpSseTransport {
    ...
    pub async fn new(http_config: HttpTransportConfig, sse_config: HttpSseConfig) -> Result<Self, crate::correlation::CorrelationError> {
    ...
    /// Get reference to session manager for connection tracking
    pub fn session_manager(&self) -> Arc<SessionManager> {
        Arc::clone(&self.session_manager)
    }
    
    /// Get reference to correlation manager for request tracking
    pub fn correlation_manager(&self) -> Arc<CorrelationManager> {
        Arc::clone(&self.correlation_manager)
    }
...
impl SseEvent {
    ...
    pub fn event_type(&self) -> &'static str {
        match self {
            SseEvent::Request(_) | SseEvent::Response(_) | SseEvent::Notification(_) => events::MESSAGE,
...
mod tests {
    ...
    async fn test_transport_creation() {
        ...
        let transport = HttpSseTransport::new(http_config, sse_config).await.unwrap();
