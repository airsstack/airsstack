...
//!
//! This module defines error types for both generic integration operations
//! and MCP-specific operations, providing comprehensive error handling.
...
impl IntegrationError {
    ...
    pub fn handler_registration(reason: impl Into<String>) -> Self {
    ...
    pub fn routing(reason: impl Into<String>) -> Self {
        Self::Routing {
            reason: reason.into(),
        }
    }
