...
impl PathPermissionValidator {
    ...
    ///
    /// ```rust
    /// # use airs_mcpserver_fs::security::permissions::PathPermissionValidator;
    ...
    ///
    /// ```rust
    /// # use airs_mcpserver_fs::security::permissions::{PathPermissionValidator, PathPermissionRule, PermissionLevel};
    /// let mut validator = PathPermissionValidator::new(true);
    ///
    ...
    /// ```rust
    /// # use airs_mcpserver_fs::security::permissions::PathPermissionValidator;
    /// # use airs_mcpserver_fs::config::settings::{SecurityPolicy, RiskLevel};
    /// let mut validator = PathPermissionValidator::new(true);
    ///
